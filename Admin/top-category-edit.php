...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        ...
        foreach($result as $row) {
            ...
            $current_tcat_image = $row['tcat_image'];
        }
    ...
    if(isset($_FILES['tcat_image']) && $_FILES['tcat_image']['name'] != '') {
        ...
        if(!in_array($file_extension, $allowed_extensions)) {
            ...
            // Remove the old image if it exists and is being replaced
            if($current_tcat_image != '' && file_exists('../assets/uploads/' . $current_tcat_image)) {
                unlink('../assets/uploads/' . $current_tcat_image);
            }
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("UPDATE tbl_top_category SET tcat_name=?, show_on_menu=?, tcat_image=? WHERE tcat_id=?");
        $statement->execute(array($_POST['tcat_name'], $_POST['show_on_menu'], $tcat_image, $_REQUEST['id']));
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php if($current_image != ''): ?>
                                    <img src="../assets/uploads/<?php echo $current_image; ?>" alt="Category Image" style="width:150px;">
                                <?php else: ?>
                                    <p>No image found</p>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="tcat_image" class="col-sm-2 control-label">Change Image</label>
                            <div class="col-sm-6">
                                <input type="file" name="tcat_image">
                            </div>
                        </div>
                        <div class="form-group">
