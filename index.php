...
<body>
  ...
  <main>
          ...
          <div class="slider-container has-scrollbar">
              ...
              foreach ($result as $row) {
                  ...
                  <div class="slider-item">
                       <a href="<?php echo $row['image_url']; ?>"><img src="assets/uploads/<?php echo $row['photo']; ?>" alt="" class="banner-img"></a>
                  </div>
                  <?php
              }
              ?>
    ...
    <?php
      $statement = $pdo->prepare("SELECT tcat_id, tcat_name, tcat_image FROM tbl_top_category");
      $statement->execute();
      ...
      foreach ($categories as $category) {
        ...
        <div class="category-item">
          <div class="category-img-box">
            <!-- Placeholder image - replace with dynamic if available -->
            <img src="assets/uploads/<?php echo $category['tcat_image']; ?>" alt="<?php echo $category['tcat_name']; ?>" width="30">
          </div>
          <div class="category-content-box">
            <div class="category-content-flex">
              <h3 class="category-item-title"><?php echo $category['tcat_name']; ?></h3>
              <!-- Example category item count - replace with dynamic data if available -->
...
<?php
  ...
  $statement = $pdo->prepare("SELECT p.*, p_id , e.ecat_name
                              FROM tbl_product p
...
?>
            <?php foreach ($products as $product): ?>
              <div class="showcase">
                  <div class="showcase-banner">
                      <img src="assets/uploads/<?php echo htmlspecialchars($product['p_featured_photo']); ?>" alt="<?php echo htmlspecialchars($product['p_name']); ?>" width="300" class="product-img default">
                      <img src="assets/uploads/<?php echo htmlspecialchars($product['p_sec_photo']); ?>" alt="<?php echo htmlspecialchars($product['p_name']); ?>" width="300" class="product-img hover">
                  ...
                  <div class="showcase-content">
                      <a href="Products.php?ecat_id=<?php echo $product['ecat_id']?>" class="showcase-category"><?php echo htmlspecialchars($product['ecat_name']); ?></a>
                      <a href="ProdDetails.php?id=<?php echo $product['p_id']?>">
                          <h3 class="showcase-title"><?php echo htmlspecialchars($product['p_name']); ?></h3>
                      </a>
                      <div class="showcase-rating">
                          <ion-icon name="star"></ion-icon>
                          <ion-icon name="star"></ion-icon>
                      ...
                      <div class="price-box">
                          <p class="price">$<?php echo htmlspecialchars($product['p_price']); ?></p>
                          <del>$75.00</del>
                      </div>
                  </div>
              </div>
